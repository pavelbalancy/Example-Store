...
#endif
        private static string PLUGINS_ADDRESS_ORIGINAL => "/Balancy/Editor/balancy_plugins.json";
        internal static string CODE_GENERATION_PATH => PLUGINS_LOCAL_FOLDER + "AutoGeneratedCode";

#if LOCAL_PLUGINS_TEST
        public const string PLUGINS_ADDRESS_REMOTE = "/balancy_plugins_remote.json";
#else
